...
function NewTeam({
  ...
  function AddSeanceSubmitForm(event: FormEvent<HTMLFormElement>): void {
    event.preventDefault();
    alert('ok');
  }

  const adresse = '10 place du stades';
  const ville = 'Les clayes sous bois ';
    ...
    <div className={openClassNames}>
      ...
      <div className="newteam__content__card ">
        ...
        stateActiveRef === true && equipe ? (
          ...
          <form onSubmit={AddSeanceSubmitForm} action="submbit" className="my-form newteam">
